                  ...
                  <div className="col-md-6">
                    ...
                    >
                      ...
                      <p style={{
                        ...
                        Nuestra visión es consolidarnos como una institución modelo donde la unión entre la comunidad educativa garantiza la excelencia.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      ...
                      <p style={{
                        ...
                        Somos parte de este territorio. Trabajamos cada día para fortalecer su cultura, su ciencia y su futuro, con las puertas abiertas a todas las familias.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="p-4 p-md-5 text-center">
                ...
                <div className="d-flex flex-wrap justify-content-center gap-2 gap-md-3">
                  {['Excelencia', 'Inclusión', 'Respeto', 'Compromiso', 'Solidaridad', 'Responsabilidad'].map((valor) => (
                    <span
                      key={valor}
                      style={{
                        ...NEUMORPH.inset,
